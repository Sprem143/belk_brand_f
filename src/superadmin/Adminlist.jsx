...
export default function Adminlist() {
    ...
    const deleteentry = async (employeeid) => {
        if (confirm('Are you sure? You want to permanently delete this admin')) {
            let res = await fetch(`${localhost}/superadmin/deleteadmin`, {
                method: 'DELETE',
    ...
    const fetchproduct = async () => {
        let res = await fetch(`${localhost}/superadmin/adminlist`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
        res = await res.json()
    ...
    const blockadmin = async (employeeid, status) => {
        let res = await fetch(`${localhost}/superadmin/blockadmin`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
