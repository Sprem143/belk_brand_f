...
export default function Admin() {
    ...
    return (
        <div className="ps-4 pe-4">
            ...
            <Button className="nobackgr" onClick={showForm}>Add Product</Button>
            ...
            <div className="container">
                <div className="row mt-4 mb-4 d-flex justify-content-center" style={{width:'75%'}}>
            ...
            <Accordion className="mb-4 mt-4" defaultActiveKey={'0'}>
                <Accordion.Item eventKey="0">
                    <Accordion.Header>Total Number of Entries : &nbsp;&nbsp; <span style={{ color: 'blue' }}>{realData.length > 1 ? data.length : 0} &nbsp;&nbsp;&nbsp;&nbsp; <button className="nobackgr" onClick={downloadexcel}> Download sheet</button> </span></Accordion.Header>
                    <Accordion.Body>

                        <div className="d-flex mb-4  p-2 bg-primary text-white">
                            <div>
                                <input type="text" value={search} className="search_box" placeholder="Search Products " onChange={(e) => { setSearch((e.target.value).trim()), searchproduct() }} onKeyDown={searchproduct} on />
                                                ...
                                                <tr className="products" key={i} style={{ minHeight: '350px !important' }}>
                                                    <td>{i}
                                                        <div className="details">
                                                            ...
                                                            {p.uploadedby && <p>Uploaded By : {p.entryby}</p>}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>{p['Vendor Tracking #']}
                                                        <div className="details2">
                                                            ...
                                                            <button onClick={() => edit(p._id)} className="nobackgr">
                                                                <a href="#form_container2"> <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className=" me-2 bi bi-pencil-square" viewBox="0 0 16 16">
